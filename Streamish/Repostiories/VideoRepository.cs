...
namespace Streamish.Repositories
{
    ...
    public class VideoRepository : BaseRepository, IVideoRepository
    {
                ...
                using (var cmd = conn.CreateCommand())
                {
                    ...
                    using (SqlDataReader reader = cmd.ExecuteReader())
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            {
                                //DbUtils is a class created to simplify some db interaction code, particularly when dealing with NULL values
                        ...
                        //code for getAll() method above gets all the data we need with a single round trip to the db
                        return videos;
                    }
                }
            }
        }
        //GetAllWithComments() method: is a special purpose method that gets all the Videos along with their comments
        //given we don't always want Comments, it doesn't make sense to add code to the GetAll() method
        ...
        //get a single video and includes video's comments
                    ...
                    using (SqlDataReader reader = cmd.ExecuteReader())
                    {
                        ...
                        while (reader.Read())
                        {
...

                            {
                                ...
                                //add as many comments for video
                                if (DbUtils.IsNotDbNull(reader, "CommentId"))
                                {
        ...
        //Search method builds a query that uses the LIKE operator to find records matching search crit and uses the 
        //sortDesc param to determine the ORDER By direction
